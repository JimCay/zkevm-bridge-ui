...
interface Env {
  ...
  VITE_ETHEREUM_BTC_TOKEN_ADDRESS: string;
...
const envToDomain = ({
  ...
  VITE_ETHEREUM_BTC_TOKEN_ADDRESS,
  ...
  return getChains({
    ethereum: {
      ...
      btcAddress:VITE_ETHEREUM_BTC_TOKEN_ADDRESS,
...
const envParser = StrictSchema<Env, domain.Env>()(
  z
    .object({
      ...
      VITE_ETHEREUM_BTC_TOKEN_ADDRESS: z.string().length(42),
